...
class AwesomeDialogEx extends StatefulWidget {
  const AwesomeDialogEx({Key? key}) : super(key: key);

  @override
  State<AwesomeDialogEx> createState() => _AwesomeDialogExState();
}

class _AwesomeDialogExState extends State<AwesomeDialogEx> {
  @override
